      ...
      <div className="relative z-10 max-w-2xl w-full px-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 md:gap-6">
          ...
          <a
            ...
            className="group flex items-center justify-center px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg"
            aria-label="LinkedIn"
          >
            <svg
              className="w-6 h-6"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-center px-4 py-3 bg-black hover:bg-gray-800 text-white rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg"
